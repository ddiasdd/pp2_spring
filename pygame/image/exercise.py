...
bg_image = pygame.image.load('pygame/image/mainclock.png')
sec_img = pygame.image.load('pygame/image/leftarm.png')
min_img = pygame.image.load('pygame/image/rightarm.png')
